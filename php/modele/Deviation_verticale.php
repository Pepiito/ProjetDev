...
# D̩viation de la verticale

# Matrice Bessel de rotation rep̬re terrestre g̩od̩sique --> rep̬re local g̩od̩sique
...
# Matrice Bessel de rotation transpos̩ rep̬re terrestre g̩od̩sique --> rep̬re local g̩od̩sique
...
# Matrice GRS80 de rotation rep̬re local g̩od̩sique --> rep̬re carth̩sien g̩od̩sique
...
# Matrice du r̩sultat du produit matriciel
#	--> Matrice GRS80 de rotation rep̬re local g̩od̩sique --> rep̬re carth̩sien g̩od̩sique
#	--> Matrice Bessel de rotation transpos̩ rep̬re terrestre g̩od̩sique --> rep̬re local g̩od̩sique
...
# Matrice du r̩sultat du produit matriciel qui donne le vecteur eta,ksi et z̩ta de la france en radians
#	--> R̩sultat du produit matriciel des Matrice GRS80 de rotation rep̬re local g̩od̩sique --> rep̬re carth̩sien g̩od̩sique et Matrice Bessel de rotation transpos̩ rep̬re terrestre g̩od̩sique --> rep̬re local g̩od̩sique
#	--> Vecteur eta, ksi et z̩ta suisse
