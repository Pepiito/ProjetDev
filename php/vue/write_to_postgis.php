...
for ($i = 0; $i<$nb_pt;$i++){
	if (isset ($_SESSION['id_sess'])){
		...
		'.$coordonnees['proj']['RGF']['C46']['a']['IGN69']['E']['E'$i].',
		'.$coordonnees['proj']['RGF']['C46']['a']['IGN69']['N']['N'$i].',
		'.$coordonnees['proj']['RGF']['C47']['a']['IGN69']['E']['E'$i].',
		'.$coordonnees['proj']['RGF']['C47']['a']['IGN69']['N']['N'$i].',
		'.$coordonnees['proj']['RGF']['C48']['a']['IGN69']['E']['E'$i].',
		'.$coordonnees['proj']['RGF']['C48']['a']['IGN69']['N']['N'$i].',
		CURRENT_DATE
		);');
		$pt_session = pg_query($conn, 
		"SELECT jsonb_build_object(
