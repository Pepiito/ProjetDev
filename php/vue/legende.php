...
<input class="recherche" type="search" placeholder="Recherche par points"/>
   ...
   <div class="border_legende">
	...
	<span id="span_plani"><p>Les systèmes des coordonnées pouvant être affichés dans la popup en cliquant sur un point</p></span>
	   ...
	   <div><input type="checkbox" name="ch1903_proj_map" id="ch1903_proj_map"/> <label for="ch1903_proj_map">MN03</label></div>
	   <div><input type="checkbox" name="ch1903plus_proj_map" id="ch1903plus_proj_map" /> <label for="ch1903plus_proj_map">MN95</label></div>
	   <div><input type="checkbox" name="rgf_proj_map" id="rgf_proj_map" /> <label for="rgf_proj_map">Lambert-93</label></div>
	   <div><input type="checkbox" name="rgf_proj_C46_map" id="rgf_proj_C46_map" /> <label for="rgf_proj_C46_map">CC46</label></div>
	   <div><input type="checkbox" name="rgf_proj_C47_map" id="rgf_proj_C47_map" /> <label for="rgf_proj_C47_map">CC47</label></div>
	   <div><input type="checkbox" name="rgf_proj_C48_map" id="rgf_proj_C48_map" /> <label for="rgf_proj_C48_map">CC48</label></div>
	   <div><input type="checkbox" name="ntf_proj_Etendu_map" id="ntf_proj_Etendu_map" /> <label for="ntf_proj_Etendu_map">Lambert II Etendu</label></div>
	   <div><input type="checkbox" name="ntf_proj_2_map" id="ntf_proj_2_map" /> <label for="ntf_proj_2_map">Lambert II</label></div>
	   </div>
	   ...
	   <div><input type="checkbox" name="hgrs80_map" id="hgrs80_map"/> <label for="hgrs80_map">Ellisoïde: IAG GRS 1980</label></div>
            ...
            <p>Système de coordonnées (système géodésique) :
                <select id="maListe" onchange="changeProjection(this.value)">
                    ...
                    <option value="EPSG:21781">MN03 (CH1903)</option>
                    <option value="EPSG:2056">MN95 (CH1903+)</option>
					</optgroup>
                </select>
            </p>
            <p id="coordonnees"></p>
